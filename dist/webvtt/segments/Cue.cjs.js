"use strict";const m=require("./Segment.cjs.js"),r=require("../../errors/InvalidCueError.cjs.js"),n=require("../../utils.cjs.js"),g=require("../Timings.cjs.js"),_=require("lodash");class e extends m{_startTime;_endTime;_text;_identifier;_settings;constructor(t,s,i,h,u){super(),this._startTime=t,this._endTime=s,this._text=i,this._identifier=h,this._settings=u||{}}vertical(t){return this._settings.vertical=t,this}line(t){return this._settings.line=t,this}position(t){return this._settings.position=t,this}size(t){return this._settings.size=t,this}align(t){return this._settings.align=t,this}removeTags(){return this._text=n.stripTags(this.text),this}toString(t){if(t==="srt"){if(!this._identifier||_.isString(this._identifier))throw new r("SRT files must have an identifier, the identifier should represent a numeric counter",`${this._identifier}
